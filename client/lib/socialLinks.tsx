...
export const socialLinks = [
  {
    name: "facebook",
    href: "https://www.facebook.com/profile.php?id=61578622972914",
    path: <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />,
  },
  {
    name: "instagram",
    href: "https://www.instagram.com/centrulculturalsarbesc?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
    path: (
      <>
  ...
  {
    name: "youtube",
    href: "https://www.youtube.com/@centrulculturalsarbesc",
    path: (
