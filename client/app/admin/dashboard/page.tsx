      ...
      <div className="max-w-[1400px] mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <StatCard
            ...
            trend={`${Math.round(
              (data.stats.ticketsSold / data.stats.totalCapacity) * 100
            )}%`}
            isPositive={true}
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-[#14120c] border border-yellow-900/20 rounded-3xl p-8 relative">
            <div className="flex justify-between items-center mb-10">
              <div>
                <h3 className="text-2xl font-black text-[#faeacc]">
                  Vânzări (7 zile)
                </h3>
              </div>
            </div>
          ...
          <div className="bg-[#14120c] border border-yellow-900/20 rounded-3xl p-8 flex flex-col">
            <h3 className="text-2xl font-black mb-8 text-[#faeacc]">
              Status Categorii
            </h3>
              ...
              {data.inventory.map((cat) => (
                <div key={cat.id} className="space-y-3">
                  <div className="flex justify-between text-sm">
                    <span className="font-bold text-yellow-100/80">
                      {cat.name}
                    </span>
                    <span className="text-yellow-600/60 font-mono">
                  ...
                  <div className="h-2 bg-yellow-900/10 rounded-full overflow-hidden border border-yellow-900/10">
                    <div
                      ...
                      style={{
                        width: `${
                          (cat.soldQuantity / cat.totalQuantity) * 100
                        }%`,
                      }}
                    ></div>
                  </div>
